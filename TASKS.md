...
- [x] **#58 — `scripts/reset-db.sql` : 6 corrections schéma**
...
- [x] **#59 — `POST /api/admin/campaigns` : snapshot destinataires avec transaction atomique**
...
- [x] **#60 — Cron `dispatch-campaigns` : 4 bugs à corriger**
...
- [x] **#61 — `POST /api/campaign-activations` : endpoint activation par token**
...
- [x] **#62 — Fix `app/api/unsubscribe/[token]/route.ts` + créer page**
...
- [x] **#63 — `app/accueillir/activer/[token]/page.tsx` : page activation email**
...
- [x] **#64 — `PATCH /api/host-activations/[id]` : RLS + retrait `is_full` + anon client**
...
- [x] **#65 — `PATCH /api/ambassadeur/enrichissement` : route questionnaire enrichissement**
...
- [x] **#66 — `/dashboard/questionnaire/page.tsx` : formulaire enrichissement**
...
- [x] **#67 — Dashboard ambassadeur : encart `pre_approved`**
...
- [x] **#68 — Email pré-approbation : ajouter lien questionnaire**
...
- [x] **#69 — Admin status route : retirer la transition directe `pre_approved → validated`**
...
- [x] **#70 — Admin `/admin/ambassadeurs` : afficher données questionnaire**
...
- [x] **#71 — `/inscription` : ajouter champ `phone` optionnel**
